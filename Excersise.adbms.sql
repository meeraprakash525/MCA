...
select hire_date from employeeswhere last_name in('Grant','Whalen');
...
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) values(207,'Paul','Newton','Stevan.paul@sqltutuorial.org','231.123.4567','1987-06-17',2,NULL,11);
